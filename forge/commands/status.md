...
3. **Read `forge-meta.json.generated.toolingFlags.hookStatus`** — onboard persists a canonical `hookStatus` telemetry object. Use it directly for the coverage report. Fields:
