...
5. **Respect the headless escape hatch**. When `callerExtras.disableOutputStyleTuning: true`, skip batched confirmation entirely; emit with inferred + wizard-default values. This is the greenfield path.
