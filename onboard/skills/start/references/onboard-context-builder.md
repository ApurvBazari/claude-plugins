...
- `installedPlugins` → from the Phase 4 plugin-detection deep probe (sibling + marketplace cache per `../../generation/references/plugin-detection-guide.md`)
...
- `pluginSurfaces` → from the Phase 4 surface probe per `../../generation/references/plugin-surface-probe.md`
