...
`claude-onboard` bridges the gap between traditional development and AI-assisted workflows. It performs deep codebase analysis, walks you through an interactive setup wizard, and generates a full suite of Claude tooling tailored to your project.
...
claude plugin add /path/to/claude-onboard

# Or use directly without installing
claude --plugin-dir /path/to/claude-onboard
```
