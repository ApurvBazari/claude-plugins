...
echo ""
echo "Next steps:"
echo "  1. cd ${BASE_DIR}/test-nextjs && claude  # Run /onboard:start"
echo "  2. cd ${BASE_DIR}/test-python && claude   # Run /onboard:start"
echo "  3. cd ${BASE_DIR}/test-monorepo && claude # Run /onboard:start"
echo "  4. cd ${BASE_DIR}/test-empty && claude    # Run /onboard:start"
