...
After all applicable categories run, hand control back to grill-spec Step 4 (conflict resolution) with the updated context. Don't write to `greenfield-state.json` yourself — grill-spec owns the checkpoint.
